...
export default function Sidebar(){
  ...
  return(<div className="sidebar">
    <div className="sidebar-logo"><h1>SmartMsg</h1><p>Automated SMS sender</p></div>
    <nav className="sidebar-nav">{NAV.map(({to,label,icon,exact})=>(
    ...
    <div className="sidebar-bottom">
      <div className="user-tag">
        ...
        <div className="user-info"><p>{user?.last_name}</p><span>{user?.phone}</span></div>
      </div>
